...
export const RaPopover = () => {
  return (
    <div className="main-popover">
      <Popover.Root>
        <Popover.Trigger className="main-popover__trigger">More info</Popover.Trigger>
        <Popover.Portal>
          {/* Добавляем обертку с CSS переменными внутри портала */}
          <div className="main-popover__portal-wrapper">
            <Popover.Content className="main-popover__content" sideOffset={5}>
              ...
              <div className="main-popover__body">
                <p className="main-popover__text">
                  Some more info… This is the detailed content that appears in the popover. You can
                  add any content here including forms, lists, etc.
                </p>
              </div>
